...
public class Group1LittleLoomLocatorApplication {
	...
	@Bean
	ApplicationRunner init(ParentRepository parentRepository, ChildRepository childRepository,
			InstituteRepository instituteRepo,NotificationRepository notificationRepository ) {
		return args -> {
			loadData(parentRepository, childRepository, instituteRepo, notificationRepository);
		};
	}

	private void loadData(ParentRepository parentRepository, ChildRepository childRepository,
			InstituteRepository instituteRepo, NotificationRepository notificationRepository) {
		ArrayList<Parent> parents = new ArrayList<>();
		parentRepository.save(new Parent("Sujeewa", "Fernando", "Sapperton", "6726678180", "sujeewau@hotmail.com",
				"Sujeewa", "6726678180"));
		parentRepository.save(new Parent("Namesh", "Chathura", "New westminster", "2369963996", "nameshm89@gmail.com",
				"Namesh", "2369963996"));
		parentRepository.save(new Parent("Indika", "Gayashan", "New westminster", "7788825994", "gayazhanmit@yahoo.com",
				"Indika", "7788825994"));

		/*
		 * courses.get(0).addSection(new Section(1)); courses.get(0).addSection(new
		 * Section(2)); courses.get(1).addSection(new Section(1));
		 * courses.get(1).addSection(new Section(2)); courses.get(1).addSection(new
		 * Section(3)); courses.get(1).addSection(new Section(4));
		...
		instituteRepo.save(new Institute("Riverside Childcare NW", "140-1110", "Ewen Ave", "New Westminster", "BC",
				"V3M 5E4", "Paul Barby", "604-354-1180", "https://riversidechildcare.ca/", "riversideccnw@gmail.com"));

		instituteRepo.save(
				new Institute("Nana Licensed Daycare", "518 E", "59th Ave", "Vancouver", "BC", "V5X 1Y3", "Nana Wilson",
						"604-367-5728", "https://nana-licensed-daycare.business.site/", "nanadaycare@gmail.com"));

		instituteRepo.save(new Institute("Sing & Smile Child Care", "12057", "82 Ave", "Surrey", "BC", "V3W 3E1",
				"Karen Beach", "778-591-5999", "http://www.singandsmilechildcare.com/", "singandsmile@gmail.com"));
